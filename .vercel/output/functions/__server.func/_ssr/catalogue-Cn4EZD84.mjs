...
//#region node_modules/.nitro/vite/services/ssr/assets/catalogue-Cn4EZD84.js
...
var $$splitComponentImporter = () => import("./catalogue-MvxIRJOu.mjs");
var catalogueSearchSchema = objectType({
...
var Route = createFileRoute("/catalogue")({
	...
	head: () => ({ meta: [{ title: "Shop Premium Bouquets — Hyper Petals Decor" }, {
		name: "description",
