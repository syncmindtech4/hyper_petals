...
//         name: "description",
//         content:
//           "Browse our signature hand-tied arrangements, roses, gift baskets, and custom floral packages in Kampala.",
//       },
//     ],
//   }),
// });
...
//         <img
//           src={heroImage}
//           alt="Hyper hand-tied P arrangements"
//           loading="eager"
//           fetchPriority="high"
...
//               premium seasonal blooms. Choose a bouquet to customize sizes, add-ons, and local
//               delivery.
//             </p>
...
//                 We couldn't find any bouquets matching your current filters. Try relaxing your
...
function Catalogue() {
  ...
  // True only on the very first fetch (no data painted yet at all) — used to
  // show a loading state instead of the "no results" empty-state, since
  // initialData: [] would otherwise make an in-flight first fetch look
  // identical to a genuinely empty filtered result.
