...
export const Route = createFileRoute("/contact")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Get in touch with Hyper Petals Decor for bouquet orders, event florals and bespoke enquiries. WhatsApp, phone, email or send us a message." },
